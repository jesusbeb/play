/* Archivo .sql para cargar datos iniciales en la BD
ON CONFLICT sirve para que no provoque error al querer volver a cargar los datos y
encuentre que el titulo ya existe, ya que Spring siempre leera este archivo
*/

INSERT INTO play_peliculas (titulo, duracion, genero, clasificacion, fecha_estreno, estado)
